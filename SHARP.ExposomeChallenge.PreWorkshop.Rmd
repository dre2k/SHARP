...
# Outcome
outcome.Name <- "e3_bw" #hs_bmi_c_cat" # "hs_asthma" # "hs_bmi_c_cat" "hs_zbmi_who"
...
# Exposure related
exposure.group <- "All" #Organochlorines" # {"Metals", "Organochlorines", "Organophosphate pesticides", "PBDE", "PFAS", "Phenols", "Phthalates", "All"}

# All potential exposures categorized by groups
S <- 7
...
if(exposure.group=="All") { exposure.Names <- unlist(exposure.Names) } # treat all groups as a single group
# create exposure matrix X and XtX matrix for g-prior
W <- scale(as.matrix(d[,exposure.Names]), center=T, scale=T)
