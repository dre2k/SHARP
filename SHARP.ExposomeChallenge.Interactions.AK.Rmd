...
# folder for analysis
# setwd("~/Google Drive/My Drive/SHARP.MultiomicsWorkshop.USC.share/")
...
NEED TO EXPLAIN DATA SOURCES, BACKGROUND, etc
...
E <- as.numeric(d[,grep(exposure.Name, names(d))])      #what David has in his rmd example
   E <- ifelse(E > 0,1,0)        #what I added since this is the E he used to simulate the gxe data
...
bdinfo <- BinaryDosage::getbdinfo("/Users/mak/Desktop/out.bdose")
...
END THE SLKDE ASKING THIS QUESTion - what do you think about scans doing SNP by SNP? in cmoplex disease with many SNPs with small effects, does this seem like the best way to do this? 
