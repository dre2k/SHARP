...
The term `e3_alcpreg_yn_None1:SNP.1` has p.value = 0.48. Hence, we cannot reject the null hypothesis and do not conclude there is statistically significant evidence of interactions on a multiplicative scale. 

<br>

## Genome-wide interaction scan {.tabset}
